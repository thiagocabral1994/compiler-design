...
public abstract class CodeGeneratorVisitor extends Visitor {
	...
	public CodeGeneratorVisitor(String templatePath, String prefix, String fileName,
			TypeEnv<LocalEnv<SemanticType>> env, Map<String, Map<String, SemanticType>> map) {
		this.PREFIX = prefix;
		this.groupTemplate = new STGroupFile(templatePath);
